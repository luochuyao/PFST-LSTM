...
from model.PFEncodeDecode import *
...
class sequence_model(object):
    def __init__(self,
        ...
        self.info = info
        self.test_save_root = '/mnt/A/meteorological/2500_ref_seq/CIKM_dec_PF_ConvLSTM_test_/'
        self.validation_save_root = '/mnt/A/meteorological/2500_ref_seq/CIKM_dec_PF_ConvLSTM_validation/'
...
if __name__ == '__main__':
    path = 'config/dec_PF_ConvLSTM_CIKM.yml'
    f = open(path)
