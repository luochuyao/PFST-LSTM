...
class sequence_model(object):
    def __init__(self,
        ...
        self.info = info
        self.test_save_root = '/mnt/A/meteorological/2500_ref_seq/CIKM_dec_TrajLSTM_test/'
        self.validation_save_root = '/mnt/A/meteorological/2500_ref_seq/CIKM_dec_TrajLSTM_validation/'
...
if __name__ == '__main__':
    path = 'config/dec_TrajLSTM_CIKM.yml'
    f = open(path)
