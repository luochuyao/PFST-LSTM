...
class sequence_model(object):
    def __init__(self,
        ...
        self.validation_save_root = '/mnt/A/meteorological/2500_ref_seq/CIKM_dec_TrajGRU_validation/'
        self.test_save_root = '/mnt/A/meteorological/2500_ref_seq/CIKM_dec_TrajGRU_test/'
        self.info = info
...
if __name__ == '__main__':
    ...
    path = 'config/dec_TrajGRU_CIKM.yml'
    f = open(path)
